...
angular.module('otrService', ['ngResource']).
  ...
  return $resource('/otr-monolith/rest/audio/:method/:id', {method: '@_method', id: '@_id'});
    }).factory('OTRAudioDataCount', function($resource){
	  return $resource('/otr-monolith/rest/audio/resultsCount/:id', {id: '@_id'});
	}).factory('OTRSeriesData', function($resource){
	  return $resource('/otr-monolith/rest/series/:method/:id', {method: '@_method', id: '@_id'});
	}).factory('OTRSeriesDataCount', function($resource){
	  return $resource('/otr-monolith/rest/series/resultsCount/:id', {id: '@_id'});
	}).factory('OTREpisodeData', function($resource){
	  return $resource('/otr-monolith/rest/episode/:method/:id', {method: '@_method', id: '@_id'});
	}).factory('OTREpisodeDataCount', function($resource){
	  return $resource('/otr-monolith/rest/episode/resultsCount/:id', {id: '@_id'});
